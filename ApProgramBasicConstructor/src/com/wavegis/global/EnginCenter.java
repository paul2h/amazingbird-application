...
import com.wavegis.engin.ws.WavegisWSEngin;


public class EnginCenter {
	/** 掛入的Engin清單(增減Engin改這個就好 View會自己變) */
	public static final Engin[] Engins = {new CCTVEngin() ,new WavegisWSEngin() , new RainDataInsertEngin() , new RawDataInsertEngin()};
