...
public class GlobalConfig {
	 ...
	 * 版本顯示設定
	 */
	public static final String edition = edition_chiayi_city;
	...
	public static final String FrameIconImagePath_ChiayiCity = "./conf/icon/icon_web_monitor.png";
	public static final String FrameIconImagePath_WebMonitor = "./conf/icon/icon_web_monitor.png";
	public static final ImageIcon FrameIconImage = new ImageIcon(FrameIconImagePath_ChiayiCity);
